...
Page({
    ...
    getLocation: function () {
        ...
        wx.request({
            ...
            success: function (res) {
                ...
                var newMeters = that.getDistance(lastMarker.latitude, lastMarker.longitude, res.data.latitude, res.data.longitude) / 1000;
    ...
    openLocation: function () {
        wx.request({
            url: "https://tenyun.mikusu.fun/flaskproject/morau?loginkey=114514",
            method: "GET",
            success: function (res) {
                console.log(res.data.latitude)
                wx.openLocation({
                    latitude: res.data.latitude,
                    longitude: res.data.ongitude,
                    scale: 28, // 缩放比例
                })
            },
        })
